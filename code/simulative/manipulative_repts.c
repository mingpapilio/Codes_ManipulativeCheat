 ...
 * Last edit: 26 May, 2022 (Ming Liu)
 **********************************************************************************************************/
...
int main(){
    // Switches
        ...
        int s4= 0;                      // 0: single-mechanism model, 1: two-mechanisms model
    // General parameters
        ...
        double a= 0.5;                  // Nonlinearity parameter fo x
        double b= 0.5;                  // Nonlinearity parameter fo u
        int N_trait= 5;
